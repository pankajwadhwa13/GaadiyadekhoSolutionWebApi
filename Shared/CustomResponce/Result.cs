...
namespace Shared.CustomResponce
{
    public class Result<T> : IResult<T>
    {
        ...
        public static Result<string> SuccessToken(string token)
        {
        ...
        public static Task<Result<string>> SuccessTokenAsync(string message)
        {
            return Task.FromResult(SuccessToken(message));
        }
