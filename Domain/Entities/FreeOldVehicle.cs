...
public partial class FreeOldVehicle
{
    ...
    public virtual BodyType BodyTypeNavigation { get; set; }

    public virtual Brand Brand { get; set; }

    public virtual ICollection<FreeOldVechileImage> FreeOldVechileImages { get; set; } = new List<FreeOldVechileImage>();
